        ...
        <div class="container">
            ...
            <div class="contact-items">
                <div class="customer-care">
                    <h3>Customer Care</h3>
                    <p>
                        Our Support team is spread all over the world to give
                        you fast response
                    </p>
                ...
                <div class="write-us">
                    <h3>Write Us</h3>
                    <p>
                        <!-- You can write us if you have any queries -->
                        mohona.chowdhury@gmail.com nabhan.abdullah@gmail.com
                        tejaswi@gmail.com <br />
                        damian.amalraj@hotmail.com
                    </p>
